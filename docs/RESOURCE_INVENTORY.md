...
- Approximate file count: `98`
- Approximate size: `116.15 MB`
...
- Model download cache: `D:\dextop\tempn\models\downloads` with `2` files, about `500.03 MB`
- Extracted Vosk model: `D:\dextop\tempn\models\vosk-model-small-en-us-0.15` with `14` files, about `67.61 MB`

### Vosk offline STT model

- Archive path: `D:\dextop\tempn\models\downloads\vosk-model-small-en-us-0.15.zip`
